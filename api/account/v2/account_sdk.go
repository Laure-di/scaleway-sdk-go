...
//	  -H "X-Auth-Token: $SCW_SECRET_KEY" \
//	  -H "Content-Type: application/json" \
//	  "https://api.scaleway.com/account/v2/projects?organization_id=b12d5c3g-c612-5674-c1e9-92627f36c5b9"
//	```
//
//	You should get a response like the following:
//
...
//     -H "X-Auth-Token: $SCW_SECRET_KEY" \
//     -H "Content-Type: application/json" \
//     "https://api.scaleway.com/account/v2/projects/6170692e-7363-616c-6577-61792e636f6d" \
//     -d '{
