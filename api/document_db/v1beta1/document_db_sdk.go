...
// # Concepts
//
// Refer to our [dedicated concepts page](https://www.scaleway.com/en/docs/managed-databases/document-database/quickstart/) to find definitions of the different terms referring to Managed Database for FerretDB.
//
// (switchcolumn)
// (switchcolumn)
//
...
//     | `engine`         | **REQUIRED** Version ID of the database engine. To check the list of available engines you can use the folowing endpoint: `https://api.scaleway.com/document-db/v1beta1/regions/$SCW_REGION/database-engines`                                           |
//     | `name`           | Name of the Database Instance                                          |
//     | `node_type`      | **REQUIRED** The node type. To check the list of available node types you can use the folowing endpoint: `https://api.scaleway.com/document-db/v1beta1/regions/$SCW_REGION/node-types`                             |
...
//     https://api.scaleway.com/document-db/v1beta1/regions/$SCW_REGION/instances \
//     -d '{
//     "project_id": "d8e65f2b-cce9-40b7-80fc-6a2902db6826",
//     "name": "myDB",
//     "engine": "FerretDB-1.0.0",
...
//     -H "X-Auth-Token: $SCW_SECRET_KEY" https://api.scaleway.com/document-db/v1beta1/regions/$SCW_REGION/instances
//     ```
//
...
//     ```bash
//     mongosh --tls --tlsCAFile rdb-myDB.pem 'mongodb://<username>@<ip-address>:<port>/rdb?authMechanism=PLAIN'
//     ```
//
...
//
// * [Managed Database for FerretDB Documentation](https://www.scaleway.com/en/docs/managed-databases/document-database/)
